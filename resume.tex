...
\section{Experience}
\cventry{Oct 2014 - Present}{Software engineer/Product owner}{En Japan}{Tokyo}{}{Work on HR services using highly concurrent technologies (Akka, Play). Designed a modular micro service architecture used by all services in the team on AWS infrastructure such as VPC, ELB, Elastic Beanstalk and RDS, developing and using Ruby for deployment. Created and managed a project with up to 10 people. More recently started a new project in Ruby on Rails.}
