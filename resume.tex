...
\homepage{ugo.me}                % optional, remove the line if not wanted
...
\section{Experience}
\cventry{April 2016 - Present}{Technical lead}{Kenzai}{Tokyo}{}{Architecturing and implementing RoR backend while leading outsource team on mobile development for both iOS and Android platforms.}
\cventry{Oct 2014 - April 2016}{Product owner - Technical lead}{En Japan}{Tokyo}{}{Work on HR services using Ruby on Rails for web services and Scala Spark distributed system for machine learning and analysis. 
  \begin{itemize}
    \item Created and managed the design and implementation of a Talent management system with a team up to 10 people.
    \item Leaded a team on the design and implementation of a japanese NLP analysis pipeline able to digest millions of sentences.
    \item Designed a modular micro service architecture used by all services in the team on AWS infrastructure such as VPC, ELB, Elastic Beanstalk and RDS.
  \end{itemize}
}
...
\cvline{CSM}{Certified ScrumMaster (CSM) on May 2016 by Scrum Alliance}
\cvline{CSPO}{Certified Scrum Product Owner (CSPO) on May 2016 by Scrum Alliance}
